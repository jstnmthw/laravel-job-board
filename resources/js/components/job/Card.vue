    ...
    <div @click="setSelected" class="relative p-5 mb-4 border dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg transition-shadow hover:shadow-lg">
        ...
        <div v-if="loading">
            <div class="animate-pulse flex space-x-4">
                <div class="rounded-full bg-gray-200 h-12 w-12 dark:bg-gray-600"></div>
                <div class="flex-1 space-y-4 py-1 mb-[2px]">
                    <div class="mt-1 h-2 bg-gray-200 rounded dark:bg-gray-600 w-1/4"></div>
                    <div class="space-y-4">
                        <div class="mb-5 h-4 bg-gray-200 rounded-lg dark:bg-gray-600"></div>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="h-2 bg-gray-200 rounded col-span-2 dark:bg-gray-600"></div>
                            <div class="h-2 bg-gray-200 rounded col-span-1 dark:bg-gray-600"></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        ...
        posted_date() {
            return formatDistanceToNowStrict(new Date(this.job.created_at))
        }
    },
    methods: {
        setSelected() {
