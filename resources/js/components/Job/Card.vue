<template>
    <div class="relative p-5 mb-4 border dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg transition-shadow hover:shadow-lg">
        ...
        <div class="ml-16">
            ...
            <h2 class="text-lg mb-2 dark:text-gray-300 whitespace-nowrap overflow-ellipsis overflow-hidden pr-16">
                {{ job.title }}
            </h2>
            <div class="flex justify-between">
                ...
                <p class="text-sm-alt text-gray-400 dark:text-gray-600">
