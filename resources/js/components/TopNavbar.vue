            ...
            <div class="relative flex items-center justify-between py-6">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex-shrink-0 flex items-center">
                        <router-link to="/">
                            <svg class="block text-orange-600 dark:text-white lg:hidden h-8 w-auto" fill="currentColor" viewBox="0 0 35 32" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg class="hidden text-orange-600 dark:text-orange-200 lg:block h-8 w-auto" fill="none" viewBox="0 0 143 32" xmlns="http://www.w3.org/2000/svg">
